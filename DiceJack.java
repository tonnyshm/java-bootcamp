...
public class DiceJack {
    public static void main(String[] args) {
        ...
        System.out.println("Enter three number btn 1 and 6");
        ...
        if(num1< 1|| num2<1 ||num3 <1){
            System.out.println("Numbers cant be less than 1.Shutting down the game...");
            System.exit(0);

        }
        if(num1> 6|| num2>6 ||num3 >6){
            System.out.println("Numbers cant exceed 6, Shutting down the game...");
            System.exit(0);
        }
